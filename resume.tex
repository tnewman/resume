...
\begin{cvskills}
    ...
    \cvskill
    {Backend}
    {Spring Boot, Flask, Microservices, MongoDB, Publish/Subscribe (Pub/Sub), REST}
...
\begin{cventries}
    ...
    {February 2018-Present}
    {
        \begin{cvitems}
            ...
            \item{Wrote microservices in Python (Flask) and Java (Spring Boot) for REST and Pub/Sub-based APIs. The microservices integrated with DynamoDB, Simple Notification Service (SNS), and Simple Queue Service (SQS).}
