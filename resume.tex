...
\begin{cventries}
    ...
    {February 2018-Present}
    {
        \begin{cvitems}
            ...
            \item{Wrote microservices in Python (Flask), JavaScript (NodeJS) and Java (Spring Boot) for REST and Pub/Sub-based APIs. The microservices integrated with DynamoDB, Simple Notification Service (SNS), and Simple Queue Service (SQS).}
